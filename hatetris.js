...
function drawReplay() {
	...
	//document.getElementById("replayOut").innerHTML = "replay of last game:<br> " + string;
}
...
//TODO this is turned off because I'm going to reuse it for something else
function drawScore() {
...
function inputHandler(transformId) {
	...
	// redraw well
  //TODO note that this is commented out - speeds things up quite a bit.
	//drawWell(liveWell);
...
function inputReplayStep() {
	...
	if(gameContinues) {
		...
		if(replayIn.length > 0) {
			...
			document.onkeydown = inputKey;
      //TODO this is where we could return if the game is over!
		}
	}
  //TODO else return game should have been longer?
}
